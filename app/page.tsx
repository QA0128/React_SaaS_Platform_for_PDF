      ...
      <main className="lg:min-h-[350px] bg-[#F2F4F8] relative overflow-hidden">
        <section className="banner m-auto ">
          <div className="relative z-1 lg:grid grid-cols-12 gap-4">
            ...
            />
            <div className="hidden lg:block absolute top-[-64px] left-[-160px] w-[1296px] h-[972px] bg-[radial-gradient(circle,_transparent_0%,_#F2F4F8_100%)]"></div>
            <div className="z-2 content-container relative lg:h-[711px] lg:col-span-7 flex flex-col justify-center">
              <div className="text-xl sm:text-2xl md:text-4xl lg:text-[54px] lg:w-[660px] font-bold mx-auto">
          ...
          <div className="z-2 relative text-sm font-semibold bg-[#F2F4F8]">
            <div className="content-container m-auto text-[#21272A] mt-3">
              We're trusted by:
            </div>
            <div className="content-container m-auto text-[#697077]">
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 pt-4 pb-4 lg:pb-[80px]">
                ...
                <div className="outlink m-2 w-full flex min-w-[200px]">
                  <Image 
                    src={`/assets/icons/smartfinder.ico`}
                    width={32}
                    height={32}
                ...
                <div className="outlink m-2 w-full flex min-w-[200px]">
                  <Image 
                    src={`/assets/icons/kontrastr.ico`}
                    width={24}
                    height={30}
                    alt="Kontrastr Icon"
                  />
                ...
                <div className="outlink m-2 w-full flex min-w-[200px]">
                  <Image 
                    src={`/assets/icons/wavesmarathon.ico`}
                    width={24}
                    height={30}
                    alt="Waves Marathon Icon"
                  />
        ...
        <section className="features bg-white">
          <div className="content-container m-auto pt-12 gap-3">
            <div className="feature-help">
              <div className="text-[#001D6C] text-[20px] font-bold text-center">
                FEATURES
              </div>
              <div className="text-[42px] font-bold text-[#21272A] text-center">
                Why Choose PDFRender.com?
              </div>
            ...
            <div className="mx-8 mt-8 py-12">
              <div className="flex grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 m-auto">
                <Feature ico="fast" title="Fast & Reliable Conversions" content="Convert HTML to PDF in seconds with consistent, high-quality results every time."/>
                <Feature ico="flexible" title="Flexible Input Options" content="Upload HTML files or paste raw text-choose the method that fits your workflow."/>
                <Feature ico="easy" title="Easy Automation Integration" content="Connect with Zapier, Make, N8N, and Workato for automated PDF generation."/>
                <Feature ico="secure" title="Secure & Private Processing" content="We process your data securely without storing it-privacy is always a priority."/>
                <Feature ico="scalable" title="Scalable for Any Business" content="Perfect for individuals or enterprises-scale as our PDF generation needs grow."/>
                <Feature ico="simple" title="Simple API Management" content="Manage API keys easily and generate PDFs programmatically with clear documentation."/>
              </div>
            </div>
          </div>
        </section>
        <section className="bg-white">
          <div className="content-container m-auto pt-8 pb-12">
            <div className="text-[42px] font-bold text-center py-4">
              How it works
            </div>
            <div className="max-w-[1170px] m-auto pt-8 flex pl-8 md:pl-0 md:block gap-4 md:gap-1 justify-center items-center">
              ...
              <div className="grid grid-row md:flex justify-between">
                <div className="w-full h-[163px] opt-step ml-8 md:ml-0 md:w-[278px] content-center relative">
                  <div style={{fontFamily:"Gilory"}} className="absolute text-9xl text-[#E7E7E7] font-bold top-[17px] right-[10px] z-1">1</div>
                  <div className="step-name relative z-2">
                    Connect Your App
                  </div>
                  <div className="step-content relative z-2">
                    Zapier, Make, N8N, Workato, or API
                  </div>
                </div>
                <div className="w-full h-[163px] opt-step ml-8 md:ml-0 md:w-[278px] content-center relative">
                  <div style={{fontFamily:"Gilory"}} className="absolute text-9xl text-[#E7E7E7] font-bold top-[17px] right-[10px] z-1">2</div>
                  <div className="step-name relative z-2">
                    Configure PDF Settings
                  </div>
                  <div className="step-content relative z-2">
                    Customize layout and data
                  </div>
                </div>
                <div className="w-full h-[163px] opt-step ml-8 md:ml-0 md:w-[278px] content-center relative">
                  <div style={{fontFamily:"Gilory"}} className="absolute text-9xl text-[#E7E7E7] font-bold top-[17px] right-[10px] z-1">3</div>
                  <div className="step-name relative z-2">
                    Automate & Generate
                  </div>
                  <div className="step-content relative z-2">
                    Receive PDFs instantly
                  </div>
                </div>
              </div>
            </div>
        ...
        <section className="integrations bg-[#F2F4F8]">
          <div className="content-container m-auto gap-3 py-[48px]">
            <div className="integration-help">
              <div className="text-[#001D6C] text-[20px] font-extrabold text-center tracking-[1px]">
                Integrations
              </div>
              <div className="text-[42px] font-bold text-[#21272A] text-center">
              ...
              <div className="max-w-[768px] text-center m-auto text-[20px] font-medium pt-4">
                Connect your tools, connect your teams. With over 200 apps already available in our directly, your team's favorite tools are just a click away.
              </div>
            </div>
            <div className="">
              <div className="flex gap-4 m-auto justify-center py-[40px]">
                <Image 
                  src="/assets/integrations/zapier.png"
                  width={80}
                  height={80}
                  alt="Zapier Banner"
                />
                <Image 
                  src="/assets/integrations/make.png"
                  width={178}
                  height={80}
                  alt="Make Banner"
                />
                <Image 
                  src="/assets/integrations/n8n.png"
                  width={250}
                  height={80}
                  alt="N8N Banner"
                />
                <Image 
                  src="/assets/integrations/w.png"
                  width={80}
                  height={80}
                  alt="W Banner"
                />
            ...
            <div className="pb-8">
              <Button color="blue" href="/integrations" className="text-white m-auto py-2 px-3">All integrations</Button>
            </div>
          </div>
        </section>
